...
@RequestMapping("/api/v1/product_photo")
public class ProductPhotoController {

    private final ProductPhotoService service;

    @PostMapping("/save")
    public ResponseEntity<?> save(@RequestBody ProductPhotoRequest request){
    ...
    @PutMapping("/edit/{id}")
    public ResponseEntity<?> edit(@RequestBody ProductPhotoRequest request, @PathVariable Long id) {
